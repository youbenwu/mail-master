...
public class SignUtils {
    ...
    private static Map<String, String> createRSAKeys(){
        ...
        try {
            ...
            //获取公、私钥值
            String publicKeyValue = com.ys.mail.model.unionPay.Base64.encode(publicKey.getEncoded());
            String privateKeyValue = com.ys.mail.model.unionPay.Base64.encode(privateKey.getEncoded());
    ...
    public static PublicKey getPublicKey(String key) {
        try {
            byte[] byteKey = com.ys.mail.model.unionPay.Base64.decode(key);
    ...
    public static String sign(String key, String requestData){
        ...
        try {
            ...
            signature = StringUtil.bytesToHexString(signed);
    ...
    public static boolean verifySign(String key, String requestData, String signature){
        ...
        try {
            ...
            verifySign.update(requestData.getBytes("GBK"));

            // verifySignSuccess = verifySign.verify(Base64.decode(signature));
            verifySignSuccess = verifySign.verify(StringUtil.hexString2Bytes(signature));
