...
import com.ys.mail.util.CaseUtil;
...
public enum SettingTypeEnum implements IPairs<Integer, String, SettingTypeEnum> {
    ...
    twenty_five(25, ""),
    twenty_six(26, ""),
    twenty_seven(27, "cpyTypeZero"),
    twenty_eight(28, "cpyTypeOne"),
    twenty_nine(29, ""),
    thirty(30, ""),
    thirty_one(31, ""),
    thirty_two(32, ""),
    ...
    @Override
    public String value() {
        if (BlankUtil.isNotEmpty(this.value)) {
            return this.value;
        }
        return CaseUtil.toCamelCase(this.name());
    }
}
