...
import com.ys.mail.config.KdBirdConfig;
...
public class KdApiOrderDistinguish {
    ...
    @Autowired
    private KdBirdConfig kdBirdConfig;
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(api.orderOnlineByJson(null));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public String orderOnlineByJson(String logisticCode) throws Exception{
        ...
        // 以form表单形式提交post请求，post请求体中包含了应用级参数和系统级参数 根据公司业务处理返回的信息......
        return sendPost(kdBirdConfig.getReqUrl(), params);
    }
     ...
     * @throws Exception 异常
     */
    public String orderOnlineByJson(String logisticCode, String shipperCode, String customerName)throws Exception {
        // 组装应用级参数
